...
def lambda_handler(event, context):  # noqa: C901
    ...
    blueprint_type = "DOCUMENT" if body["file_name"].lower().endswith(".pdf") else "IMAGE"
    ...
    LOGGER.info(f"Data automation job metadata S3 location: {job_metadata_s3_location}")
